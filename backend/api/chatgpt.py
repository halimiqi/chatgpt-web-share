...
#         })
#         ## self.openAIbot = xxxxxxx  
#         self.semaphore = asyncio.Semaphore(1)
#         self.chatbot_new = ChatModel(mode = ChatModels.default)
#     def is_busy(self):
...
#     ## 使用官方API, 
#     def ask_new(self, message, conversation_id: str = None, parent_id: str = None,
#                 timeout=360, model_name: ChatModels=None):
#         return self.chatbot_new.ask(conversation_id, message, create_time)
